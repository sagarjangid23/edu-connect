...
urlpatterns = [
    ...
    path("teachers/<int:teacher_id>/", corresponding_students, name="corresponding_students"),
    path("students/<int:student_id>/", corresponding_teachers, name="corresponding_teachers"),
